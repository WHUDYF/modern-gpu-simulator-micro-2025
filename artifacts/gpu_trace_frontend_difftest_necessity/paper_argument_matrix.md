...
|----------|------|-----------------|---------|----------|------------|---------------|------------|---------------|----------------------|--------|
| BERT-base (encoder layer slice) | slice | 0.5 (modeled) | 9 (measured) | 3217 (measured) | 25732 (measured) | 25.873564588 (measured) | 46.873564588 (measured) | 55.2 (measured) | 18.1 (modeled) | Expected 30% reduction saves 7.8s per run |
