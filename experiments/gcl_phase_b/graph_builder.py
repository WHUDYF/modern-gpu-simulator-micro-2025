...
def build_phase_b_graph(record: dict[str, Any]) -> dict[str, Any]:
    ...
    graph = {
        ...
        "artifact_status": record.get("artifact_status", "formal"),
        "formal_input_eligible": record.get("formal_input_eligible", True),
        "workload_id": record.get("workload_id"),
        "execution_mode": record.get("execution_mode"),
        "trace_source": record.get("trace_source"),
        "input_scope": record.get("input_scope"),
        "scheduler_metadata_source": record.get("scheduler_metadata_source"),
